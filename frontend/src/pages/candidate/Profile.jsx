          ...
          <div className="bg-white rounded-2xl shadow-xl border border-gray-100 overflow-hidden">
            ...
            <div className="px-8 py-8">
              ...
              <div className="mt-8 pt-6 border-t border-gray-200">
                <label className="flex items-center text-sm font-medium text-gray-500 mb-4">
                ...
                {user?.resume ? (
                  <button
                    ...
                    className="w-full sm:w-auto px-6 py-3 bg-linear-to-r from-emerald-500 to-emerald-600 hover:from-emerald-600 hover:to-emerald-700 text-white font-semibold rounded-lg shadow-sm transition flex items-center justify-center gap-2"
                  >
                    <FileText className="w-5 h-5" />
                    View Resume
                  </button>
                ) : (
                  <p className="text-gray-500 pl-6">No resume uploaded</p>
                )}
              </div>
            </div>
          </div>
          ...
          <div className="bg-white rounded-2xl shadow-2xl w-full max-w-5xl h-[90vh] flex flex-col">
            ...
            <div className="flex items-center justify-between px-6 py-4 border-b border-gray-200">
              <h3 className="text-xl font-bold text-gray-900 flex items-center gap-2">
                ...
                { user?.username.charAt(0).toUpperCase() + user?.username.slice(1) } - Resume
              </h3>
              <button
