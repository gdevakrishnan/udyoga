...
import { Briefcase, Mail, Lock, Eye, EyeOff, ArrowRight, User, Upload, Building, FileText } from 'lucide-react';
  ...
  const validateForm = () => {
    ...
    if (formData.role === 'candidate') {
      ...
      if (!formData.company_description.trim()) {
        newErrors.company_description = 'Company description is required for recruiters';
      } else if (formData.company_description.length < 20) {
        newErrors.company_description = 'Company description must be at least 20 characters';
      }
    }
  ...
  const handleSubmit = () => {
    if (validateForm()) {
      ...
      console.log('Registration Data:', {
        ...
        role: formData.role,
        ...(formData.role === 'candidate' && { resume: selectedFile?.name }),
    ...
    <div className="py-12 min-h-screen bg-gradient-to-br from-emerald-50 via-white to-emerald-50 flex items-center justify-center px-4 sm:px-6 lg:px-8">
      ...
      <div className="max-w-md w-full relative">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-gray-600">Join Udyoga and start your career journey</p>
        </div>
        ...
        <div className="mt-6 text-center">
          <p className="text-gray-600">
            ...
            <Link to={'/login'} className="font-semibold text-emerald-600 hover:text-emerald-500 transition">Sign in</Link>
          </p>
        </div>
      </div>
    </div>
